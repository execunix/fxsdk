...
/* Output various other options (as gleaned from include/config.h.in) */
	...
	output(screen, "   HAVE_LINUX_DQBLK_XFS_H\n");
#endif
#ifdef HAVE_LINUX_INOTIFY_H
	output(screen, "   HAVE_LINUX_INOTIFY_H\n");
#endif
#ifdef HAVE_LOCALE_H
	...
	output(screen, "   HAVE_UUID_UUID_H\n");
#endif
...
#endif
#ifdef HAVE_UT_UT_ADDR_V6
	output(screen, "   HAVE_UT_UT_ADDR_V6\n");
#endif
...
#endif
#ifdef HAVE_CTDB_CONTROL_TRANS2_COMMIT_RETRY_DECL
	output(screen, "   HAVE_CTDB_CONTROL_TRANS2_COMMIT_RETRY_DECL\n");
#endif
#ifdef HAVE_CUPS
...
#endif
#ifdef HAVE_KRB5_VERIFY_CHECKSUM
	output(screen, "   HAVE_KRB5_VERIFY_CHECKSUM\n");
#endif
...
#endif
#ifdef HAVE_SHORT_KRB5_MK_ERROR_INTERFACE
	output(screen, "   HAVE_SHORT_KRB5_MK_ERROR_INTERFACE\n");
#endif
	...
	output(screen, "   HAVE_STAT_ST_ATIMESPEC\n");
#endif
#ifdef HAVE_STAT_ST_ATIME_N
	output(screen, "   HAVE_STAT_ST_ATIME_N\n");
#endif
#ifdef HAVE_STAT_ST_BIRTHTIME
	output(screen, "   HAVE_STAT_ST_BIRTHTIME\n");
#endif
#ifdef HAVE_STAT_ST_BIRTHTIMENSEC
	output(screen, "   HAVE_STAT_ST_BIRTHTIMENSEC\n");
#endif
#ifdef HAVE_STAT_ST_BIRTHTIMESPEC
	output(screen, "   HAVE_STAT_ST_BIRTHTIMESPEC\n");
#endif
	...
	output(screen, "   HAVE_STAT_ST_CTIMESPEC\n");
#endif
#ifdef HAVE_STAT_ST_CTIME_N
	output(screen, "   HAVE_STAT_ST_CTIME_N\n");
#endif
	...
	output(screen, "   HAVE_STAT_ST_MTIMESPEC\n");
#endif
#ifdef HAVE_STAT_ST_MTIME_N
	output(screen, "   HAVE_STAT_ST_MTIME_N\n");
#endif
#ifdef HAVE_STAT_ST_UATIME
	output(screen, "   HAVE_STAT_ST_UATIME\n");
#endif
#ifdef HAVE_STAT_ST_UCTIME
	output(screen, "   HAVE_STAT_ST_UCTIME\n");
#endif
#ifdef HAVE_STAT_ST_UMTIME
	output(screen, "   HAVE_STAT_ST_UMTIME\n");
#endif
	...
	output(screen, "   HAVE_UUID_GENERATE\n");
#endif
...
#endif
#ifdef HAVE___NR_INOTIFY_INIT_DECL
	output(screen, "   HAVE___NR_INOTIFY_INIT_DECL\n");
#endif
#ifdef HAVE___OPEN
...
#endif
#ifdef WITH_CIFSUPCALL
	output(screen, "   WITH_CIFSUPCALL\n");
#endif
#ifdef WITH_DFS
	...
	output(screen, "   ENABLE_BUILD_FARM_HACKS\n");
#endif
	...
	output(screen, "   KRB5_TICKET_HAS_KEYINFO\n");
#endif
	...
	output(screen, "   REPLACE_STRPTIME\n");
#endif
#ifdef RETSIGTYPE
...
#endif
#ifdef ptrdiff_t
	output(screen, "   ptrdiff_t\n");
#endif
#ifdef rpc_dssetup_init
	output(screen, "   rpc_dssetup_init\n");
#endif
#ifdef rpc_eventlog2_init
	output(screen, "   rpc_eventlog2_init\n");
#endif
#ifdef rpc_initshutdown_init
	output(screen, "   rpc_initshutdown_init\n");
#endif
#ifdef rpc_lsarpc_init
	output(screen, "   rpc_lsarpc_init\n");
#endif
#ifdef rpc_netdfs_init
	output(screen, "   rpc_netdfs_init\n");
#endif
#ifdef rpc_netlogon_init
	output(screen, "   rpc_netlogon_init\n");
#endif
#ifdef rpc_ntsvcs2_init
	output(screen, "   rpc_ntsvcs2_init\n");
#endif
#ifdef rpc_rpcecho_init
	output(screen, "   rpc_rpcecho_init\n");
#endif
#ifdef rpc_samr_init
...
#endif
#ifdef rpc_srvsvc_init
	output(screen, "   rpc_srvsvc_init\n");
#endif
#ifdef rpc_svcctl2_init
	output(screen, "   rpc_svcctl2_init\n");
#endif
#ifdef rpc_winreg_init
	output(screen, "   rpc_winreg_init\n");
#endif
#ifdef rpc_wkssvc_init
	output(screen, "   rpc_wkssvc_init\n");
#endif
#ifdef size_t
